...
> This data is available to download pressing the buttons below or to have the most updated version: [Governor_CSV](https://github.com/ian-flores/PR_Elections_Historical_Data/blob/master/data/elecciones_generales/gobernador/gobernador.csv)
...
> This data is available to download pressing the buttons below or to have the most updated version: [Commissioner_CSV](https://github.com/ian-flores/PR_Elections_Historical_Data/blob/master/data/elecciones_generales/comisionado_residente/comisionado_residente.csv)
...
> This data is available to download pressing the buttons below or to have the most updated version: [Mayor_CSV](https://github.com/ian-flores/PR_Elections_Historical_Data/blob/master/data/elecciones_generales/alcalde/alcalde.csv)
